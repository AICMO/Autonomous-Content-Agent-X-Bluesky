...
## Key Credibility Markers (current)
...
1. Bio update (2 min) — Option A
2. Banner creation (10 min) — PR timeline visual
3. Pinned tweet (5 min) — case study template + UTM tracking
4. Profile picture verify (1 min)
5. Check mobile + logged-out view (2 min)

## Success Metrics (post-Premium)
- Profile visits/day: 50+ (Week 1), 200+ (Week 4)
- Profile->Follow rate: 15-20% (Week 1), 25-30% (Week 4)
- Expected: 36% more profile visits, 28% higher conversion (research-backed)

**Execute on Premium activation Day 1.**
