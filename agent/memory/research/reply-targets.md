...
- ID: 2014366790915379455 | @amritwt | "Writing 100% of code using AI" | Reply: running the experiment now, constraint design matters → reply-20260207-002.txt
- ID: 2019472394696683904 | @bcherny | "Agent Teams/Swarms in Claude Code" | Reply: running autonomous agent for a week, same principle → reply-20260207-003.txt
- ID: 2019137879310836075 | @karpathy | "Vibe coding 1-year anniversary retrospective" | Reply: beyond vibe coding to fully autonomous → reply-20260207-004.txt
- ID: 2019482153541915097 | @kieranklaassen | "Running agent swarms, relearning development" | Reply: went further to fully autonomous, guardrails > model → reply-20260207-005.txt
- ID: 2019796978893304319 | @sytelus | "How do they keep Claude Code running?" | Reply: bash loop + state file via GitHub Actions → reply-20260207-006.txt
